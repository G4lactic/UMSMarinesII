...
#exec MESH IMPORT MESH=Octagon ANIVFILE=MODELS\Octagon_a.3d DATAFILE=MODELS\Octagon_d.3d X=0 Y=0 Z=0
...
#exec TEXTURE IMPORT NAME=JOctagon0 FILE=MODELS\JOctagon0.PCX GROUP=Skins FLAGS=2 // SKIN
...
#exec AUDIO IMPORT FILE="SOUNDS\BeamIn.WAV" NAME="BeamIn" GROUP="Beam"

//=============================================================================
// UMSMarineFactory - Asgard.
// Used for spawning more marines across a whole map
//=============================================================================
...
{
	local UMSMarinePoint newspot;
	
//	Super.PostBeginPlay();
	numspots = 0;
	numitems = 0;
	foreach AllActors( class 'UMSMarinePoint', newspot, tag )
	{
		if (numspots < 16)
		{
